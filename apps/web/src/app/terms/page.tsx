  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 text-[var(--text-primary)]">
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-[var(--text-secondary)]">
        ...
        <p>You retain ownership of all content you create and publish through the Service. You grant us a limited license to transmit your content to connected platforms as directed by you.</p>
        <h2 className="text-lg font-semibold text-[var(--text-primary)]">Termination</h2>
        <p>You may disconnect your accounts and stop using the Service at any time. We may suspend access for violations of these terms.</p>
