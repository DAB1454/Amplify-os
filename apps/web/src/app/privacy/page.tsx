  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16 text-[var(--text-primary)]">
      ...
      <div className="mt-6 space-y-4 text-sm leading-relaxed text-[var(--text-secondary)]">
        <p>AmplifyMe (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) respects your privacy. This policy describes how we collect, use, and protect your information.</p>
        ...
        <p>We use your information solely to provide the AmplifyMe service — publishing content, managing campaigns, and displaying analytics from your connected accounts.</p>
        ...
        <p>For privacy questions, contact us at support@amplifyme.app.</p>
      </div>
    </main>
  );
}
